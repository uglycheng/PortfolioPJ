...
crypto_symbols_info = finnhub_client.crypto_symbols('COINBASE')
symbols = [i["symbol"] for i in crypto_symbols_info]
...
for s in symbols:
    try:
        with open(s+'.json','w') as f:
            f.write((json.dumps(finnhub_client.crypto_candles(s, 'D', start_timestamp, end_timestamp))))
    except:
        continue
